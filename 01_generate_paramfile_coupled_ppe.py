...
parm_conf = ParameterFileConfig(
    param_ranges_inpath=script_dir.joinpath('input_files', 'new_ppe_noresm3_tuningparameterinfo.ini').resolve(),
    param_sample_outpath=script_dir.joinpath('input_files', 'new_ppe_noresm3_tuningparameterinfo.nc').resolve(),
    chem_mech_file=None,
...
visualize_paramfile(
    ...
    save_path=script_dir.joinpath('output_files', 'figures', 'new_ppe_noresm3_tuningparameterinfo.png').resolve(),
)
