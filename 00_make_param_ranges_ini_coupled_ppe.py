...
input_csv_file = script_dir.joinpath('input_files', 'mini_ppe_noresm3_tuningparameterinfo.csv').resolve()
if not input_csv_file.is_file():
    raise FileNotFoundError(f"Input CSV file '{input_csv_file}' not found.")

output_ini_file = script_dir.joinpath('input_files', 'mini_ppe_noresm3_tuningparameterinfo.ini').resolve()
